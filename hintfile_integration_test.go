...
func TestHintFileIntegration_WriteMergeRestartVerify(t *testing.T) {
	...
	opts.Dir = filepath.Join(t.TempDir(), "test-hintfile-integration")
...
func TestHintFileIntegration_EnableDisableToggle(t *testing.T) {
	...
	opts := DefaultOptions
	opts.SegmentSize = 64 * KB
	opts.Dir = filepath.Join(t.TempDir(), "test-hintfile-toggle")
	...
	firstIDs := mergeFileIDs(setsEnabled)
...
func TestHintFileIntegration_MultipleMerges(t *testing.T) {
	...
	opts.Dir = filepath.Join(t.TempDir(), "test-hintfile-multi-merge")
	opts.EnableHintFile = true
...
func TestHintFileIntegration_MixedDataStructures(t *testing.T) {
	opts := DefaultOptions
	opts.SegmentSize = 64 * KB
	opts.Dir = filepath.Join(t.TempDir(), "test-hintfile-mixed-ds")
	opts.EnableHintFile = true
...
func TestHintFileIntegration_CrashRecovery(t *testing.T) {
	...
	opts := DefaultOptions
	opts.SegmentSize = 64 * KB
	opts.Dir = filepath.Join(t.TempDir(), "test-hintfile-crash")
	opts.EnableHintFile = true
...
func TestHintFileIntegration_ConcurrentOperations(t *testing.T) {
	...
	opts := DefaultOptions
	opts.SegmentSize = 64 * KB
	opts.Dir = filepath.Join(t.TempDir(), "test-hintfile-concurrent")
	opts.EnableHintFile = true
...
func TestHintFileIntegration_LargeDataset(t *testing.T) {
	...
	opts.Dir = filepath.Join(t.TempDir(), "test-hintfile-large")
	opts.EnableHintFile = true
