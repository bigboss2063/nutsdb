...
func TestDB_Close_CompleteShutdownFlow(t *testing.T) {
	...
	require.Equal(t, StatusOpen, db.statusManager.Status())
...
func TestDB_Close_WithActiveTxs(t *testing.T) {
	...
	activeTxCount := db.transactionManager.GetActiveTxCount()
...
func TestDB_Close_Timeout(t *testing.T) {
	...
	db.statusManager.config.ShutdownTimeout = 1 * time.Second
